...
public class CameraControls : MonoBehaviour {
    ...
    void Start()
    {
        deformation = FindObjectOfType<Deformation>();
        Init();
    }
    void OnEnable() { Init(); }
    ...
    public void Init()
    {
        Quaternion initialRotation = Quaternion.Euler(25,0,0);
        Vector3 initialPosition = new Vector3(-13, 260, -195);
    ...
    void LateUpdate()
    {
        if (deformation.terrainMod == Deformation.TerrainMod.None) // Change this to check raycastHittingTerrain and test out on the iPad
        {
